...
class RepoStatusTest(TestCase):
    ...
    def test_status_green(self):
        ...
        status, error_mex = tagControl(test_tag_date, test_branch_date, test_id_commit_branch, test_id_commit_tag, test_mr, test_tag_parent_date, False, last_pipeline_status, parent)
    ...
    def test_last_tag_protected_no_default_branch(self): # se un tag è protetto in un branch che non sia quello di default
        ...
        status, error_mex = tagControl(test_tag_date, test_branch_date, test_id_commit_branch, test_id_commit_tag, test_mr, test_tag_parent_date, True, last_pipeline_status, parent)
        self.assertEqual(status, "red")
